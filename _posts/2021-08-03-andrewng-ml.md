...
<div align="center">
<img src="http://image.showmeai.tech/course/andrewng-ml-1.png" width = "100%" />
</div>

本课程是 Stanford CS229的内容拓展版，由吴恩达教授讲授，课程更广泛地介绍了机器学习、数据挖掘和统计模式识别等主题：
- 监督学习（参数/非参数算法、支持向量机、核、神经网络）
- 无监督学习（聚类、降维、推荐系统、深度学习）
- 机器学习的最佳实践（偏差/方差理论、机器学习和人工智能的创新过程）
- 案例研究和实践应用（构建智能机器人、文本理解、计算机视觉、医疗信息学、音频、数据库挖掘等领域）
...
<div align="center">
<img src="http://image.showmeai.tech/course/andrewng-ml-2.png" width = "100%" />
</div>
## 更多技术与课程清单 | 点击查看详细课程
<style>
#customers {
...
<div align="center">
<img src="http://image.showmeai.tech/course/andrewng-ml-3.png" width = "100%" alt="end" align=center />
</div>
