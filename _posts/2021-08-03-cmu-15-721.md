...
<div align="center">
<img src="http://image.showmeai.tech/course/CMU-15-721-1.png" width = "100%" />
</div>

CMU 15-721是卡内基梅隆大学讲授的数据库方向进阶课程，讨论了很多数据库方向的新的技术研究方向与话题，适合有数据库基础又想在该方向有深入研究的同学学习。

课程内容覆盖 内存数据库、并发控制、索引、存储模型、数据库压缩、协议、网络、调度规划、查询执行、查询编译、哈希连接、查询优化、超内存数据库 等内容。
...
<div align="center">
<img src="http://image.showmeai.tech/course/CMU-15-721-2.png" width = "100%" />
</div>
## 更多技术与课程清单 | 点击查看详细课程
<style>
#customers {
...
<div align="center">
<img src="http://image.showmeai.tech/course/CMU-15-721-3.png" width = "100%" alt="end" align=center />
</div>
