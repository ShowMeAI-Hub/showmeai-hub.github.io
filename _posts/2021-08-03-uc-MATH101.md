...
<div align="center">
<img src="http://image.showmeai.tech/course/UC-MATH101-1.png" width = "100%" />
</div>

课程主页：[教授主页](https://homepages.uc.edu/~bazetttr/wordpress/)

MATH101是Trefor Bazett教授制作的数学课程，本课程对数学中的核心知识，借助于可视化的方式，做了生动的讲解。Calculus Ⅱ是其中的微积分2课程，内容覆盖 定积分、级数、多元函数、偏导、泰勒展开、极坐标等，形象的可视化与活泼的授课方式，让你更好地掌握抽象的数学知识，为其他工科方向课程学习打好基础。


<hr />
<h2 id="ShowMeAI课程解读">ShowMeAI课程解读：全套资料</h2>
<div align="center">
<img src="http://image.showmeai.tech/course/UC-MATH101-2.png" width = "100%" />
</div>
...
<div align="center">
<img src="http://image.showmeai.tech/course/UC-MATH101-3.png" width = "100%" alt="end" align=center />
</div>